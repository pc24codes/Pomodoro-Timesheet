...
<div className="sign-in-background">
  ...
  style={{borderRadius:"50%", maxWidth:"15%"}} /> {/* Add logo image */}
</div>
                <h2 className="text-center mt-2 mb-4">Tickster Timesheets 👋 </h2>
                ...
                <div 
                className="text-center mt-2" style={{color:"black", fontSize:"12px"}}>
                <a href="https://www.freepik.com/free-vector/sign-up-concept-illustration_20824341.htm#query=signup&position=0&from_view=keyword&track=sph&uuid=e4887d48-c3b4-4ed4-911f-4b88ddbbb943">Image by storyset</a>
